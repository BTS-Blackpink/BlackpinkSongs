class Form1 {
    constructor() {
      ...
      this.y = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Stay", "_self");
      this.z = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Playing with fire", "_self");
      this.aa = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Ddu du ddu du", "_self");
      this.ab = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Whistle", "_self");
      this.ac = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "As if it's your last", "_self");
      this.ad = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Boombayah", "_self");
      ...
      this.ah = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Lovesick girls", "_self");
      this.ai = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Don't know what to do", "_self");
      this.aj = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Playing with fire", "_self");
      this.ak = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Forever young", "_self");
      this.al = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Ddu du ddu du", "_self");
      this.am = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Whistle", "_self");
      this.an = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "As if it's your last", "_self");
      this.ao = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Boombayah", "_self");
      this.ap = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Kill this love", "_self");
      this.aq = createA('http://www.youtube.com/watch?v=b73BI9eUkjM', "Solo", "_self");
    }
